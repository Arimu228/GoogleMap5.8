package com.example.googlemap58
...
import com.example.googlemap58.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun drawPolygon(){
        val options = PolygonOptions().addAll(points).fillColor(ContextCompat.getColor(this,R.color.purple))
